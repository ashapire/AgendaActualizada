package edu.mx.tesoem.itics.alan.agenda7t11;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper admin = new edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper(getApplicationContext(),"administracion",null,1);
    ...
    public void Eliminar(View view){
        edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper admin = new edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper
        ...
        if(!codigo.isEmpty()){
            ...
            if(cantidad == 1){
                ...
                edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper adminn = new edu.mx.tesoem.itics.alan.agenda7t11.AdminSQLiteOpenHelper(getApplicationContext(),"administracion",null,1);
                lvv = (GridView)findViewById(R.id.lista);
